    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" flex justify-start ">
                <a href="{{route('admin.businesses.create')}}" class="px-4 py-2 bg-green-400 rounded-md">Create Business</a>
            </div>
            <br>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                    ...
                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <div class="text-sm font-normal text-gray-500">{{$user->check}}$</div>
                                    </div>
                                </td>
                                <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{{$user->email}}</td>
                                <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{{$user->BIN}}</td>
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    <div class="flex ">
                                        ...
                                        <form method="POST" action="{{ route('admin.businesses.destroy', $user->id) }}" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
