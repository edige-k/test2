    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" flex justify-start ">
                <a href="{{route('admin.permissions.create')}}" class="px-4 py-2 bg-green-400 rounded-md">Create Permission</a>
            </div>
            <br>
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($permissions as $permission)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="  whitespace-nowrap space-x-3 mr-5">
                                    <div class="flex ">
                                    <a href="{{route('admin.permissions.edit',$permission->id)}}" type="button" data-modal-toggle="user-modal" class="mr-[20px] text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
